"use strict";
class StringHelper {
    static copyStringsIntoStringsAtPos(stringsToCopyFrom, stringsToCopyInto, pos) {
        ...
        for (var y = 0; y < stringsToCopyFrom.length; y++) {
            ...
            for (var x = 0; x < stringToCopyFrom.length; x++) {
                ...
                StringHelper.setCharAtPosInStrings(sourceChar, targetPos, stringsToCopyInto);
            }
        }
    }
    static setCharAtPosInStrings(charToSet, pos, strings) {
