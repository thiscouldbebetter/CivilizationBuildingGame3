...
class DifficultyLevel
{
	...
	turnsMax: number;
	startingCash: number;
	basePopulationBeforeDiscontent: number;
	buildDiscountForComputerPlayers: number;
	barbarianAttackMultiplier: number;
	...
	static _instances: DifficultyLevel_Instances;
	static Instances(): DifficultyLevel_Instances
	{
	...
	static byName(name: string): DifficultyLevel
	{
...
{
	Chieftan: DifficultyLevel;
	Warlord: DifficultyLevel;
	Prince: DifficultyLevel;
	King: DifficultyLevel;
	Emperor: DifficultyLevel;
	Deity: DifficultyLevel;

	_All: DifficultyLevel[];
	_AllByName: Map<string, DifficultyLevel>;

	constructor()
	{
		var dl = (n: string, tm: number, sc: number, bpbu: number, bdfcp: number, bam: number) =>
	...
	byName(name: string): DifficultyLevel
	{
