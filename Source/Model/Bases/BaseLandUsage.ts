...
class BaseLandUsage
{
	...
	offsetInUseAdd(offset: Coords): void
	{
	...
	optimize(world: World, base: Base): BaseLandUsage
	{
	...
	resourcesProducedThisTurn(world: World, base: Base): ResourceProduction
	{
	...
	): string
	{
		...
		var territoryAsLines = new Array<string>();
