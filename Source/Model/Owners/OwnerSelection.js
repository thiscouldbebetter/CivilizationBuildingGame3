...
class OwnerSelection {
    ...
    baseSelectNextIdle(owner) {
        ...
        var areThereAnyBasesIdle = bases.some(x => x.isIdle());
    ...
    baseSelected(owner) {
        var bases = owner.bases;
        var base = (this.baseSelectedIndex == null
            ? null
    ...
    unitSelectNextIdle(owner) {
        var units = owner.units;
        var areThereAnyUnitsIdle = units.some(x => x.isIdle());
    ...
    unitSelected(owner) {
        var units = owner.units;
        var unit = (this.unitSelectedIndex == null
            ? null
