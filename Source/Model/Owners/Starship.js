...
class OwnerStarshipStatus {
    ...
    hasPartsNeededToLaunch() {
        var nonStructuralComponentCount = this.fuelTanks
            + this.habitats
            + this.lifeSupports
            + this.powerplants
            + this.thrusters;
        var hasPartsNeeded = (this.fuelTanks >= 1
            && this.habitats >= 1
            && this.lifeSupports >= 1
            && this.powerplants >= 1
            && this.thrusters >= 1
    ...
    speedInLightSecondsPerTurn() {
        ...
        var speedPerThrusterMax = OwnerStarshipStatus.speedInLightSecondsPerTurnPerThruster();
        var speedPerThrusterAdjusted = speedPerThrusterMax * fuelTankCount / thrusterCount;
    ...
    turnsToReachDestinationTotal() {
        ...
        var turnsToReachDestinationTotal = Math.ceil(OwnerStarshipStatus.distanceToDestinationInLightSeconds()
            / speedInLightSecondsPerTurn);
    ...
    equals(other) {
        var areEqual = (this.fuelTanks == other.fuelTanks
