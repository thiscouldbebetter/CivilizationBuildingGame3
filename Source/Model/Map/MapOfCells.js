...
class MapOfCells {
    ...
    cellIndexToPosInCells(cellIndex, cellPosInCells) {
        cellPosInCells.overwriteWithDimensions(cellIndex % this.sizeInCells.x, Math.floor(cellIndex / this.sizeInCells.x), 0);
    }
    ...
    draw(universe, world) {
        ...
        var cameraCornerPositions = camera.cornerPositionsClockwiseFromLowerRight();
