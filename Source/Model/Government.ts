...
class Government
{
	...
	_industryConsumedByUnitsSupportedByBase: (b: Base) => number;
	...
	(
		...
		discontentPopulationMitigatedByMartialLaw: number,
		corruptionPerUnitDistanceFromCapital: number,
		industryConsumedByUnitsSupportedByBase: (b: Base) => number
	)
	{
		this.name = name;
	...
	industryConsumedByUnitsSupportedByBase(base: Base): number
	{
