...
class Technology
{
	...
	governmentAllowedName: string;
	buildablesAllowedNames: string[];
	...
	static _instances: Technology_Instances;
	static Instances(): Technology_Instances
	{
	...
	static byName(name: string): Technology
	{
		return Technology.Instances().byName(name);
	}

	prerequisitesAreSatisfiedByTechnologies(technologiesKnown: Technology[]): boolean
	{
...
{
	_Basic: Technology;
	AdvancedFlight: Technology;
	Alphabet: Technology;
	AmphibiousWarfare: Technology;
	Astronomy: Technology;
	AtomicTheory: Technology;
	Automobile: Technology;
	Banking: Technology;
	BridgeBuilding: Technology;
	BronzeWorking: Technology;
	CeremonialBurial: Technology;
	Chemistry: Technology;
	Chivalry: Technology;
	CodeOfLaws: Technology;
	CombinedArms: Technology;
	...
	Feudalism: Technology;
	Flight: Technology;
	Fundamentalism: Technology;
	FusionPower: Technology;
	GeneticEngineering: Technology;
	GuerrillaWarfare: Technology;
	Gunpowder: Technology;
	HorsebackRiding: Technology;
	Industrialization: Technology;
	Invention: Technology;
	IronWorking: Technology;
	LaborUnion: Technology;
	Laser: Technology;
	Leadership: Technology;
	Literacy: Technology;
	MachineTools: Technology;
	...
	MobileWarfare: Technology;
	Monarchy: Technology;
	Monotheism: Technology;
	Mysticism: Technology;
	Navigation: Technology;
	NuclearFission: Technology;
	...
	Stealth: Technology;
	SteamEngine: Technology;
	Steel: Technology;
	Superconductor: Technology;
	Tactics: Technology;
	Theology: Technology;
	TheoryOfGravity: Technology
	Trade: Technology;
	University: Technology;
	WarriorCode: Technology;
	Wheel: Technology;
	Writing: Technology;

	_All: Technology[];
	_AllByName: Map<string, Technology>;

	constructor()
	{
		var t = (n: string, rtl: number, pn: string[], ga: Government, ba: any[]) =>
			new Technology(n, rtl, pn, (ga == null ? null : ga.name), ba.map(x => x.name) );
		var costTodo = 10;
		var prereqsNone = new Array<string>();
		var buildablesNone = new Array<any>();
		var govNone = null;
		...
		var prereqsSet = (tech: Technology, prereqs: Technology[]) => { tech.prerequisiteNames = prereqs.map(x => x.name); };
